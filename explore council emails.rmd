...
This is interesting. I appears that there are many non-overlapping cliques. We have one major network and then many small disconnected graphs.
...
num_words <- 5 #number of words to visualize
