...
clean_unnest <- data_clean %>% 
  ...
  filter(!str_detect(word, '[0-9]+'),
         ...
         str_detect(word, '[a-z]+')) %>% # have some issues with non-ASCII charachters causing problems
